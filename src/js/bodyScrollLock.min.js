        ...
        (c = [].concat(
          ...
          i
            ? ((r.ontouchstart = function (e) {
              ...
              a ||
                (document.addEventListener('touchmove', d, t ? { passive: !1 } : void 0), (a = !0)))
            : (function (e) {
                if (void 0 === v) {
    ...
    (exports.clearAllBodyScrollLocks = function () {
      i
        ? (c.forEach(function (e) {
          ...
          a &&
            (document.removeEventListener('touchmove', d, t ? { passive: !1 } : void 0), (a = !1)),
          (u = -1))
        : n(),
        (c = []);
    }),
        ...
        ? ((c = c.filter(function (e) {
          ...
          i
            ? ((o.ontouchstart = null),
              ...
              a &&
                0 === c.length &&
                (document.removeEventListener('touchmove', d, t ? { passive: !1 } : void 0),
                (a = !1)))
            : c.length || n())
        : console.error(
